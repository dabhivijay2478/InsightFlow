...
No AWS, Vercel, or infra steps here — use [observability-deployment.md](./deployment.md) only when you are ready to deploy env vars.
...
- [observability-deployment.md](./deployment.md) — put `phc_...` into Vercel / AWS SSM and redeploy
