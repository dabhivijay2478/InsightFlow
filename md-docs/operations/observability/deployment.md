...
> [OVHcloud deployment guide](../../deployment/infrastructure/ovh-microsandbox-runbook.md) for current
...
Current infrastructure: [OVH and Microsandbox deployment runbook](../../deployment/infrastructure/ovh-microsandbox-runbook.md).
...
- [deployment-vercel.md](../../deployment/frontend/vercel.md)
