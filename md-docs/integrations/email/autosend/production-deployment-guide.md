...
Use the templates in [`supabase-auth-email-templates.md`](../supabase-auth-templates.md). Copy only the raw HTML inside each code block, not the Markdown heading or backticks.
