...
5. Add the JavaScript transformation from [`dodo-autosend-transformations.md`](../../billing/dodo-autosend-transformations.md).
...
4. Set all backend `AUTOSEND_TEMPLATE_*` variables from [`autosend-template-id-map.md`](./template-id-map.md).
