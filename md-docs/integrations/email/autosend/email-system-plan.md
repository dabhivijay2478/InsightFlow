...
See [`dodo-autosend-transformations.md`](../../billing/dodo-autosend-transformations.md) for transformation examples and [`autosend-template-id-map.md`](./template-id-map.md) for the 11 Dodo-owned template IDs.
...
Use [`autosend-dodo-supabase-production-runbook.md`](./dodo-supabase-production-runbook.md) for the full production checklist, Supabase signup timeout troubleshooting, and Dodo dashboard setup steps.
