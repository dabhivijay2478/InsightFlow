...
Visual map of how Dodo Payments connects to the MantrixFlow stack. The current architecture is documented in [`billing-dodo-billingsdk.md`](./dodo-billingsdk.md).
