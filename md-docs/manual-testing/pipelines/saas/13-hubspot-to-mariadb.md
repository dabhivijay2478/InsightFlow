...
> DDL identical to `12-hubspot-to-mysql.md` with `DATETIME(6)` and `LONGTEXT`.  
...
CREATE TABLE analytics.hs_nps (
    ...
    nps_score     INT, comment LONGTEXT, submitted_at DATETIME(6)
) ENGINE=InnoDB;
