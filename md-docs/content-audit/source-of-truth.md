...
Current infrastructure guidance is the Hetzner/Terraform documentation. AWS/ECS and CDK deployment documents are historical references and must retain an archive warning; they are not current deployment instructions.
