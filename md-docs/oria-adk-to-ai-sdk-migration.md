...
See [`oria-agent-setup.md`](./oria-agent-setup.md) for operator setup.
...
| Browser Release 1–6 | Pending operator | Requires live OpenRouter key + signed-in session; see [`oria-browser-ui-test-log.md`](./oria-browser-ui-test-log.md) |

Keyword routing tests were removed from `internal/agents/*_test.go` because routing is now LLM-owned in Next.js.

## Remaining follow-ups

1. Run full browser regression with OpenRouter credits per [`oria-agent-testing-guide.md`](./oria-agent-testing-guide.md).
