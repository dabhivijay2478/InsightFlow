...
| ---: | --- | --- | ---: |
| Root + 1 | Read | [`oria-test-prompts-release1-read.md`](./oria-test-prompts-release1-read.md) | `oria` + 12 read specialists |
| 2 | Action | [`oria-test-prompts-release2-action.md`](./oria-test-prompts-release2-action.md) | 12 action specialists (pipeline build, connections, transforms, runs) |
| 3 | Automation | [`oria-test-prompts-release3-automation.md`](./oria-test-prompts-release3-automation.md) | 12 automation specialists |
| 4 | Intelligence | [`oria-test-prompts-release4-intelligence.md`](./oria-test-prompts-release4-intelligence.md) | 12 intelligence specialists |
| 5 | Enterprise | [`oria-test-prompts-release5-enterprise.md`](./oria-test-prompts-release5-enterprise.md) | 12 enterprise specialists |
| 6 | Platform | [`oria-test-prompts-release6-platform.md`](./oria-test-prompts-release6-platform.md) | 12 platform specialists |
...
1. Go API with `AGENT_RUNTIME_ENABLED=true` and `AGENT_LLM_SYNTHESIS=true` (see [`oria-agent-setup.md`](./oria-agent-setup.md)).
...
- Runtime setup: [`oria-agent-setup.md`](./oria-agent-setup.md)
- Migration report: [`oria-adk-to-ai-sdk-migration.md`](./oria-adk-to-ai-sdk-migration.md)
- Browser test log: [`oria-browser-ui-test-log.md`](./oria-browser-ui-test-log.md)
